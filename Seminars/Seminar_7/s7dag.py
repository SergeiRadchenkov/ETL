...
task1 = BashOperator(
task_id='pyspark',
bash_command='export SPARK_HOME=/home/spark && export PATH=$PATH:$SPARK_HOME/bin:$SPARK_HOME/sbin && python3 /home/sergei/s6.py',
dag=dag1)
task2 = BashOperator(
task_id='spark',
bash_command='export SPARK_HOME=/home/spark && export PATH=$PATH:$SPARK_HOME/bin:$SPARK_HOME/sbin && spark-shell -i /home/sergei/s6s1.scala',
dag=dag1)
task2 >> task1
#DAG3
...
def hello(**kwargs):
  ...
  df=5+5
  print(df)
  df=pd.read_excel('/home/sergei/s4_2.xlsx')
  con=create_engine("mysql://Airflow:Airflow1!@localhost:33061/spark")
  print(df)
...
hello_file_operator = BashOperator(task_id= 'hello_file_task' , bash_command='sh /home/sergei/s6.sh ', dag=dag11) 
